...
def generate_email_html(full_name, recipient_email=None, subject=None, custom_html=None):
    ...
    # Tracking elements
    event_url = "https://calendly.com/santoshuk/1-2-1?month=2025-10"
            ...
            <a href="{tracking_link}" target="_blank"
              ...
              Schedule a Meeting
                    ...
                    <p style="margin-top:25px; font-size:14px;">
                      <strong>Santosh Kumar<br/>
                      Director | B2B Growth Expo<br/>
                      <a href="https://www.linkedin.com/in/santoshkmis/" target="_blank" style="color:#0A66C2; text-decoration:none;">Connect with me on LinkedIn</a><br>
                      <a href="mailto:santosh@b2bgrowthexpo.com" style="color:#D7262F;">santosh@b2bgrowthexpo.com</a><br/>
                      (+44) 2034517166
                    </p>
...
def send_email(sender_email, sender_password, row, subject, custom_html):
    try:
        server = smtplib.SMTP("mail.b2bgrowthexpo.com", 587)
        server.starttls()
...
sender_email = st.text_input("Sender Email", value="santosh@b2bgrowthexpo.com")
